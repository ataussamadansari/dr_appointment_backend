...
import { createAppointment, createAppointmentValidation, getBookingRequirements, getNextDaySlots } from '../controllers/appointmentController.js';
...
appointmentRoutes.get('/booking-requirements', getBookingRequirements);
